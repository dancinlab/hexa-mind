<!-- @canonical-origin: canon@a86ca143:papers/n6-hexa-neuro-paper.md (moved 2026-05-10) -->
<!-- gold-standard: shared/harness/sample.md -->
---
domain: neuro
requires: []
---
# [CANONICAL v2] Ultimate neuro (HEXA-HEXA-NEURO) — n=6 Arithmetic Coordinate Mapping

> **Author**: Park Min-woo (canon)
> **Category**: neuro — n=6 arithmetic seed paper
> **Version**: v2 (2026-04-14 canonical)
> **Upstream BT**: BT-405, BT-406, BT-132, BT-405, BT-406
> **Linked atlas node**: `neuro` 0/24 EXACT [10*]

---

## 0. Abstract

This paper demonstrates that the core parameters of the neuro domain are systematically
...
interlocks with the basic numerical values of neuro. Atlas.n6 registration: 0/24 items EXACT.

This paper does not claim a new neuro; it is a seed paper that assigns **n=6 arithmetic
...
neuro(neuro) is reinterpreted within the n=6 arithmetic system. The perfect number n=6
simultaneously satisfies the number-theoretic constant family σ(6)=12, τ(6)=4, φ=2,
sopfr(6)=5, which structurally aligns with the core parameters of the neuro domain.
**This paper assigns an n=6 arithmetic coordinate system on top of existing neuro knowledge.**

| Effect | Before | After HEXA-HEXA-NEURO | Perceived change |
|--------|--------|----------------------|------------------|
...
uniqueness necessarily interlocks with the basic numerical values of neuro.

### What n=6 coordinate mapping changes

```
  Before: "Why is this neuro value this number?" → experience/convention
  HEXA:   "This neuro value = σ(6) or τ(6) or sopfr(6)" → number-theoretic necessity
       ↓
...
## §2 COMPARE (legacy neuro vs n=6) — performance comparison (ASCII)
...
### Performance-comparison ASCII bars (legacy neuro method vs HEXA-HEXA-NEURO)
...
```
+--------------------------------------------------------------------------+
|                    HEXA-HEXA-NEURO           system structure             |
+------------+------------+------------+------------+----------------------+
...
4. **Domain overlap**: the σ=12 axis is a common parameter shared by neuro and dozens of other domains.
...
HEXA-HEXA-NEURO stagewise maturity roadmap — verification density increases per Mk:

<details open>
<summary><b>Mk.V — 2045+ integrated completion (target)</b></summary>

Target: complete integration of the full neuro domain into n=6 arithmetic. Cross-reference
...
Map neuro core parameters to σ/τ/φ/sopfr/J_2.
...
Verify with stdlib only whether HEXA-HEXA-NEURO is physically / mathematically /
...
Check whether the main neuro scaling laws follow exponents τ(6)=4 or sopfr(6)=5 via log-log regression.
...
NEURO-domain physical bounds (Carnot / Shannon / Bekenstein, etc.) checked separately.
...
#!/usr/bin/env python3
# -----------------------------------------------------------------------------
# §7 VERIFY -- HEXA-HEXA-NEURO n=6 honesty verification (stdlib only, neuro domain)
#
...
FALSIFIERS = [
    "If neuro main-parameter n=6 alignment < 70%, retire the core claim of this paper",
